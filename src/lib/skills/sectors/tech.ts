...
export const TECH_SKILL_TAXONOMY: Record<string, SkillTaxonomyEntry> = {
  yaml: {
    displayName: "YAML",
...
export const TECH_IMPOSTER_QUESTIONS: DiscoveryQuestion[] = [
  {
...
export const TECH_TRACK_SKILL_KEYS: Record<CareerTrack, string[]> = {
